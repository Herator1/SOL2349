...
**they need the station.**

---

# Part 1 — Routine and the Signal
...
A weak irregularity appears in passive sensors. It does not match any registered traffic, beacon, or charted structure in the ship’s current path.
...
## GM Push if the Table Hesitates
...
> Hundreds.
> 
> You are already inside the debris field.
...
Once the worst of the impacts pass, the players must regain control of the ship.
...
# Part 3 — What the Damage Means

## GM Summary

Once the ship is stable enough for assessment, the players learn the real problem:

the _Asterion_ is not destroyed, but it **cannot safely make the return journey**.

This is the key transition from “ship in trouble” to “we need another solution.”

---

## Damage Assessment

The fusion core is still live. Emergency maneuvering remains possible. Life support can be maintained for now.

The critical loss is in the drive system:

the debris strike has destroyed the **magnetic nozzle containment and alignment assembly**.

Without it, the ship cannot produce a controlled main burn.

### 🎙️ Read Aloud — Realization

> The main drive is no longer responding.
> 
> The reactor is still live. Internal systems still answer. The ship can still maneuver on emergency thrust.
> 
...
With the ship stabilized, the players can finally understand the anomaly they flew into.

The debris field begins to resolve into the aftermath of a battle: the remains of a destroyed combat-capable vessel, scattered wreckage, and — deeper in — a hidden station built into a mined-out asteroid.
...
Once enough systems are back online, the players scan the surrounding volume.
...
Do not let the opening routine run too long.  
Do not let the debris strike become a giant tactical minigame.  
Do let the players make meaningful contributions during the crisis.
